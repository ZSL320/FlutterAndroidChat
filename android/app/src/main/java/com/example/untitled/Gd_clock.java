...
public class Gd_clock extends Activity implements LocationSource, AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gd_clock);
            ...
            case R.id.btn_check_in:
                if (locLatLng != null && comLatLng != null) {
                    ...
                    if (distance <= radius) {
                        ...
                        Toast.makeText(Gd_clock.this,"打卡成功",Toast.LENGTH_SHORT).show();
//                        ToastUtil.showToastLong("打卡成功");
                    } else {
                        Toast.makeText(Gd_clock.this,"当前位置不打卡范围内，打卡失败",Toast.LENGTH_SHORT).show();
//                        ToastUtil.showToastLong("当前位置不打卡范围内，打卡失败");
                    }
                } else {
                    Toast.makeText(Gd_clock.this,"位置初始化异常，打卡失败",Toast.LENGTH_SHORT).show();
...
//        options.title(buffer.toString());
    ...
    public void showPermissions() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
            ...
            ActivityCompat.requestPermissions(Gd_clock.this, new String[]{
        ...
        switch (requestCode) {
            ...
            case WRITE_COARSE_LOCATION_REQUEST_CODE:
                if (grantResults.length > 0
                    ...
                    // 没有获取到权限，做特殊处理
                    Toast.makeText(Gd_clock.this,"获取位置权限失败，请手动开启",Toast.LENGTH_SHORT).show();
